...
_VERSION = metadata.version("mathlibtools")
AUTOGENERATED_MARKER = dedent(
    f"""\
    # This file was autogenerated by leanproject {_VERSION}.
    #
    # It is not intended to be edited by hand until/unless you have
    # familiarized yourself with Lean.
    """
)
...
class LeanProject:
    ...
    def write_config(self) -> None:
        ...
        with (self.directory/'leanpkg.toml').open('w') as cfg:
            cfg.write(AUTOGENERATED_MARKER)
            cfg.write('[package]\n')
